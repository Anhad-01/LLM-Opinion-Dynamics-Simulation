...
By utilizing a dedicated **AI Judge**, the system continually evaluates and scores the sentiment of each agent's argument, plotting exactly how their viewpoints drift and adapt over time as they interact with other AI outputs.
